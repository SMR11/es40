...
public:
	...
	template <class Other> 
	CAutoPtr& assign(const CAutoPtr<Other>& ptr)
	{
		if (ptr.get() != _ptr)
		{
			if (_ptr) _ptr->release();
	...
	template <class Other> 
	CAutoPtr& operator = (const CAutoPtr<Other>& ptr)
	{
		return assign<Other>(ptr);
	}

	void swap(CAutoPtr& ptr)
	{
	...
	bool operator == (const CAutoPtr& ptr) const
	{
...
template <class C>
inline void swap(CAutoPtr<C>& p1, CAutoPtr<C>& p2)
{
	p1.swap(p2);
}
