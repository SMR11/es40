...
/**
 * $Id: Thread_POSIX.h,v 1.1 2008/05/31 15:47:29 iamcamiel Exp $
 *
...
private:
	struct CThreadData: public CRefCountedObject
	{
		CThreadData():
			pTarget(0),
			thread(0),
	...
	CSignalHandler::JumpBufferVec _jumpBufferVec;
...
// inlines
//
inline int CThreadImpl::getPriorityImpl() const
{
	return _pData->prio;
}
...
inline void CThreadImpl::yieldImpl()
{
	sched_yield();
}
