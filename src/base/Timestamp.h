...
inline CTimestamp::TimeVal CTimestamp::epochMicroseconds() const
{
	return _ts;
}
...
inline CTimestamp::TimeVal CTimestamp::resolution()
{
	return 1000000;
}


inline void swap(CTimestamp& s1, CTimestamp& s2)
{
	s1.swap(s2);
}
